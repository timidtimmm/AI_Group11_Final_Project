...
def main():
    ...
    plt.title('Training Loss Curve (use demand data)')
    save_path = os.path.join(base_dir, 'training_loss_global_demand.png')
    ...
    results_df.to_csv(os.path.join(save_dir, 'LSTM_results_global_demand.csv'), index=False)
    print("\nResults saved to LSTM_results_global_demand.csv")
