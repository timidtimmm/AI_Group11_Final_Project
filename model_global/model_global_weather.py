...
def main():
    ...
    plt.title('Training Loss Curve (use weather data)')
    save_path = os.path.join(base_dir, 'training_loss_global_weather.png')
    ...
    results_df.to_csv(os.path.join(save_dir, 'LSTM_results_global_weather.csv'), index=False)
    print("\nResults saved to LSTM_results_global_weather.csv")
