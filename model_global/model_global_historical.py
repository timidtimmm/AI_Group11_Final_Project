...
def main():
    ...
    torch.save(model.state_dict(), f"./model_global_historical/LSTM_model_global_historical.pth")
    ...
    pred_df.to_csv("LSTM_predictions_global_historical.csv", index=False)
