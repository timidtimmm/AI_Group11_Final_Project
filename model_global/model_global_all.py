...
def main():
    ...
    torch.save(model.state_dict(), f"./model_global_all/LSTM_model_global_all.pth")
    ...
    plt.savefig('training_loss_global_all.png')
    plt.show()
    # Validation
    model.eval()
    with torch.no_grad():
    ...
    pred_df.to_csv("LSTM_predictions_global_all.csv", index=False)
    ...
    results_df.to_csv("LSTM_results_global_all.csv", index=False)
