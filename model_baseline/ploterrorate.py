...
plot_with_error_rate('./model_baseline/linear_regression_predict_all.csv', './model_baseline/linear_regression_error_all', 'using all features')
plot_with_error_rate('./model_baseline/linear_regression_predict_demand.csv', './model_baseline/linear_regression_error_demand', 'using demand feature')
plot_with_error_rate('./model_baseline/linear_regression_predict_historical.csv', './model_baseline/linear_regression_error_historical', 'using historical feature')
plot_with_error_rate('./model_baseline/linear_regression_predict_weather.csv', './model_baseline/linear_regression_error_weather', 'using weather feature')