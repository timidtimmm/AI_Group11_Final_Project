...
def main():
    ...
    for name, group in grouped:                     #train group by group
        ...
        os.makedirs("models_street_historical", exist_ok=True)
        torch.save(model.state_dict(), f"./models_street_historical/LSTM_model_{street}.pth")

    # Save results to CSV
    results_df = pd.DataFrame(results)
    results_df.to_csv("LSTM_street_results_historical.csv", index=False)
    print("\nResults saved to LSTM_street_results_historical.csv")
