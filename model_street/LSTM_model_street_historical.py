...
#training the model by grouping by street and using only historical traffic data
def main():
    ...
    for name, group in grouped:                     #train group by group
        ...
        os.makedirs("./model_street/models_street_historical", exist_ok=True)
        torch.save(model.state_dict(), f"./model_street/models_street_historical/LSTM_model_{street_name}.pth")
        joblib.dump(scaler, f"./model_street/models_street_historical/scaler_x_{street_name}.pkl")
        joblib.dump(target_scaler, f"./model_street/models_street_historical/scaler_y_{street_name}.pkl")
