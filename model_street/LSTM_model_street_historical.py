...
def main():
    ...
    for name, group in grouped:                     #train group by group
        ...
        results.append({'street': street, 'MSE': val_mse, 'MAE': val_mae})


    # Save results to CSV
    results_df = pd.DataFrame(results)
    results_df.to_csv("lstm_results_historical.csv", index=False)
    print("\nResults saved to lstm_results_historical.csv")
