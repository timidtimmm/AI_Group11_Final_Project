...
plot_with_error_rate('./model_street/LSTM_street_predict_all.csv', './model_street/street_error_all', 'using all features')
plot_with_error_rate('./model_street/LSTM_street_predict_demand.csv', './model_street/street_error_demand', 'using demand feature')
plot_with_error_rate('./model_street/LSTM_street_predict_historical.csv', './model_street/street_error_historical', 'using historical feature')
plot_with_error_rate('./model_street/LSTM_street_predict_weather.csv', './model_street/street_error_weather', 'using weather feature')