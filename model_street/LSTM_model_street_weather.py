...
def main():
    ...
    all_preds_df.to_csv("./model_street/LSTM_street_predict_weather.csv", index=False)
    print("All true and predicted values saved to LSTM_street_predict_weather.csv")
