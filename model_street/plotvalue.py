...
file_path = './model_street/LSTM_street_predict_all.csv'
df = pd.read_csv(file_path)

# Create output directory for plots
output_dir = './model_street/street_plots_all'
...
# Load CSV file street predictions
file_path = './model_street/LSTM_street_predict_demand.csv'
df = pd.read_csv(file_path)

# Create output directory for plots
output_dir = './model_street/street_plots_demand'
os.makedirs(output_dir, exist_ok=True)
...
# Load CSV file street predictions
file_path = './model_street/LSTM_street_predict_historical.csv'
df = pd.read_csv(file_path)

# Create output directory for plots
output_dir = './model_street/street_plots_historical'
os.makedirs(output_dir, exist_ok=True)
...
# Load CSV file street predictions
file_path = './model_street/LSTM_street_predict_weather.csv'
df = pd.read_csv(file_path)

# Create output directory for plots
output_dir = './model_street/street_plots_weather'
os.makedirs(output_dir, exist_ok=True)
