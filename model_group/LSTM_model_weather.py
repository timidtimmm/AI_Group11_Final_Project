...
#training by grouping with (boro, street) and using weather data
def main():
    ...
    all_preds_df.to_csv("./model_group/LSTM_group_predict_weather.csv", index=False)
    print("All true and predicted values saved to LSTM_group_predict_weather.csv")
