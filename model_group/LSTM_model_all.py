...
def main():
    ...
    for name, group in grouped:                     #train group by group
        ...
        os.makedirs("./model_group/models_group_all", exist_ok=True)
        torch.save(model.state_dict(), f"./model_group/models_group_all/LSTM_model_{boro_name}_{street_name}.pth")
        joblib.dump(scaler, f"./model_group/models_group_all/scaler_x_{boro_name}_{street_name}.pkl")
